...
export default function Car(props) {
  ...
  if (props.state.accent) {
    materials["body.focus"].color.set(props.state.accent)
  }

  if (props.state.plastic) {
    materials["body.plastic"].color.set(props.state.plastic)
    materials["bumpers.plastic"].color.set(props.state.plastic)
  }

  if (props.state.exhaust) {
    materials["exhaust.metal"].color.set(props.state.exhaust)
  }
